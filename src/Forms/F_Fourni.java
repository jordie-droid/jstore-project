 ...
 */
public class F_Fourni extends javax.swing.JDialog {

    /**
     * Creates new form F_Fourni
     */
    public F_Fourni(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Zref, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                    .addComponent(Znoms)
                    .addComponent(Zadr)
                    .addComponent(Ztel)
                    .addComponent(Zmail))
            ...
            .addGroup(imagePanel1Layout.createSequentialGroup()
                ...
                .addGroup(imagePanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(imagePanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Zrech, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ControleurFournisseur c = new ControleurFournisseur(Zref.getText(), Znoms.getText(), Zadr.getText(), Zmail.getText(), Ztel.getText(), Zrech.getText());
        c.enregistrer();
        Zref.setText(null);
        Znoms.setText(null);
        Zadr.setText(null);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ControleurFournisseur c = new ControleurFournisseur(Zref.getText(), Znoms.getText(), Zadr.getText(), Zmail.getText(), Ztel.getText(), Zrech.getText());
        c.rechercher();
        Zref.setText(c.getReferenceFournisseur());
        Znoms.setText(c.getNomsFournisseur());
        Zadr.setText(c.getAdresseFournisseur());
        Zmail.setText(c.getMailFournisseur());
        Ztel.setText(c.getTelephoneFournisseur());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Fourni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                F_Fourni dialog = new F_Fourni(new javax.swing.JFrame(), true);
